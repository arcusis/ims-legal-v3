...
במגבלות המקסימליות המותרות על פי חוק, בשום מקרה לא תהיה איי.אמ.אס טכנולוגיות, לרבות נציגיה, אחראית על:
...
3. **הגבלת חבות כספית**:
   - בשום מקרה לא תעלה חבות כוללת של איי.אמ.אס טכנולוגיות בגין כל תביעה על פי תנאים אלו וה-SLA על הסכום הנמוך מבין:
     - 5,000 דולר ארה"ב; או
     - הסכום הכולל ששולם בפועל על ידי הלקוח לאיי.אמ.אס טכנולוגיות ב-12 החודשים שקדמו לתביעה. כמו כן, החברה אינה נושאת בחבות כלשהי עבור תשלומים שיגרמו לנזקים נוספים שאינם מכוסים במסגרת החוזית המקורית.

4. **אחריות מוגבלת על מוצרים ושירותים**:
...
7. **קבלת אשראי שירות כפתרון בלעדי**:
   - הלקוח מאשר ומסכים כי קבלת אשראי שירות כפי שנקבע ב-SLA מהווה את הפתרון הבלעדי והיחיד עבורו. למרות כל הוראה סותרת וכפוף ל-SLA, איי.אמ.אס טכנולוגיות לא תפצה את הלקוח ולא תהיה אחראית כלפיו במקרה של:
     1. חוסר מקום אחסון בדיסק הקשיח של השרתים.
     2. תקלות בחומת האש.
     3. מתקפות מניעת שירות (DOS) או מתקפות מניעת שירות מבוזרות (DDOS).
...
8. **ויתור על פיצויים אחרים**:
   - הלקוח מוותר על כל זכות לתבוע או לדרוש פיצויים אחרים, כולל נזקים תוצאתיים, אובדן רווח
