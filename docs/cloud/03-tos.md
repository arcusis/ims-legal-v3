...
**5. תשלום - פלטפורמת הענן של איי.אמ.אס טכנולוגיות**

הלקוחות ישלמו לחברת איי.אמ.אס טכנולוגיות את העמלות המפורטות והמפורטות באתר ובטופס ההזמנה הזמין בכתובת [הפלטפורמה שלנו](https://platform.cloud.ims-network.net/report). כל תשלום יתבצע באמצעות כרטיסי אשראי בלבד, לאחר קבלת חשבונית חודשית שתישלח לכתובת הדוא"ל של הלקוח. התשלומים יבוצעו באמצעות מערכת הסליקה המנוהלת על ידי חברת PayMe. החברה שומרת לעצמה את הזכות להוסיף או לשנות את שיטות התשלום בכל עת לפי שיקול דעתה הבלעדי.

### **5.1 פרטי תשלום**

- **מטבע וחיובים:** במקרה שבו החיובים מתבצעים במטבע שונה מהמטבע המופיע באתר, שיעור ההמרה שיוגדר בחשבונית הראשונה יישמר כשיעור ההמרה המינימלי לכל החשבוניות הבאות. כל הלקוחות המקומיים בישראל יחויבו במטבע ILS (ש"ח) על פי שער ההמרה של בנק יהב לעובדי המדינה. עם זאת, שער ההמרה לא יפחת מ-3.70 ש"ח ל-1.00 דולר ולא יעלה על 4.30 ש"ח ל-1.00 דולר, בנוסף למס ערך מוסף מקומי התקף בישראל. כמו כן, תחול עמלת ניהול של 2% מסכום החשבונית.

- **חיוב אוטומטי:** המוצרים והשירותים יחויבו באופן אוטומטי על בסיס חודשי מתחדש. במקרה של תקופת ניסיון חינם או מבצע, בתום התקופה השירותים יהפכו לחיוביים אלא אם הלקוח יסגור את כל השרתים והשירותים הפעילים בחשבונו לפני סיומה.

- **שינויים במחירים:** מעת לעת, בשל שינויים שאינם תלויים באיי.אמ.אס טכנולוגיות, כגון עליות בעלויות המס, מחירי החשמל או רישיונות צד ג', החברה שומרת לעצמה את הזכות לשנות את מחירי העמלות בכל עת. עדכונים אלו יועברו ללקוחות באמצעות הודעת דוא"ל או בהודעה על החשבונית, והשינויים ייכנסו לתוקף באופן מיידי.

### **5.2 מדיניות תשלום נוספת**
...
### **5.3 ביטול עסקה והחזרים עבור תשתיות ענן**
...
כל בקשה להחזר תיבחן על בסיס אישי בהתאם למדיניות ה-SLA ותישקל על פי שיקול דעתה הבלעדי של איי.אמ.אס טכנולוגיות. הוראות אלו חלות אך ורק על מוצרים ושירותים הקשורים לתשתיות הענן של החברה, ולא ניתן לשנותם או לבטלם אלא אם כן צוין אחרת במפורש בהסכם ה-SLA.

השימוש בתשתית מהווה הסכמה למדיניות החברה. קבלות לתשלום נשלחות ב-1 לחודש, ויש לשלם עד ה-10 לחודש. לאחר מכן, תתווסף ריבית פיגור של 50% עד ה-20 לחודש. אם הלקוח לא משלם, המשתמש שלו יושבת. תשתית במחיר מעל 50 דולר לחודש מחייבת חתימת הסכם ענן, והתשלום מתבצע מראש, כולל פיקדון לחודש הבא.
